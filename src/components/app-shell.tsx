...
const navGroups: Array<{ label: string; items: NavItem[] }> = [
  {
    ...
    items: [
      ...
      },
      {
        href: "/reportes",
        label: "Reportes",
        description: "Utilidad, resurtido y alertas",
        icon: FileSpreadsheet,
        key: "reportes",
        aliases: ["reportes", "utilidad", "resurtido", "alertas", "setup"],
      },
      {
        href: "/meli",
        label: "Conexiones",
        description: "Mercado Libre y sync",
        icon: Store,
        key: "meli",
        aliases: ["meli"],
      },
      {
        href: "/cuenta",
        label: "Cuenta",
        description: "Acceso, usuarios y ajustes",
        icon: UserCircle,
        key: "cuenta",
        aliases: ["cuenta", "configuracion", "importar", "usuarios", "auditoria"],
      },
    ],
  },
  {
